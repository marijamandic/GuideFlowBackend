...
VALUES 
    ...
    '[{{"Time": 120, "TransportType": 2}}, {{"Time": 30, "TransportType": 0}}]',false);
INSERT INTO tours."Tours"(
	"Id", "Name", "AuthorId", "Description", "Level", "Status", "StatusChangeDate", "LengthInKm", "Price", "AverageGrade", "Taggs", "WeatherRequirements", "TransportDurations", "IsPremium")
VALUES 
    ...
    '[{{"Time": 90, "TransportType": 1}}, {{"Time": 45, "TransportType": 2}}]',false); 
INSERT INTO tours."Tours"(
    "Id", "Name", "AuthorId", "Description", "Level", "Status", "StatusChangeDate", "LengthInKm", "Price", "AverageGrade", "Taggs", "WeatherRequirements", "TransportDurations", "IsPremium")
VALUES 
   ...
   100, 4.7, ARRAY['Nature', 'Lake', 'Hiking'], '{{"MinTemperature": 0, "MaxTemperature": 10, "SuitableConditions": [3,4]}}',
    '[{{"Time": 150, "TransportType": 0}}, {{"Time": 60, "TransportType": 1}}]',false);
INSERT INTO tours."Tours"(
    "Id", "Name", "AuthorId", "Description", "Level", "Status", "StatusChangeDate", "LengthInKm", "Price", "AverageGrade", "Taggs", "WeatherRequirements", "TransportDurations", "IsPremium")
VALUES 
    ...
    '[{{"Time": 240, "TransportType": 0}}, {{"Time": 90, "TransportType": 1}}]',false);