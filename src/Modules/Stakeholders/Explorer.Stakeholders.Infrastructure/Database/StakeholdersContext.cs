...
namespace Explorer.Stakeholders.Infrastructure.Database
{
    public class StakeholdersContext : DbContext
    {
        ...
        public DbSet<ProfileInfo> Profiles { get; set; } // From HEAD
        public DbSet<Problem> Problem { get; set; } // From the other branch
        ...
        private static void ConfigureStakeholder(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProfileInfo>() // From HEAD
                .HasOne<User>()
                .WithOne()
